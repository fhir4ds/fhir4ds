...
from runner.config import get_suite_paths, OUTPUT_CQL_PY_DIR
from runner.cli import _discover_measures
from runner.database import BenchmarkDatabase
from runner.test_loader import load_test_suite
from runner.measure_runner import run_measure

OUTPUT_RUNS_DIR = BENCHMARKING_DIR / "output" / "comparison_runs"
OUTPUT_RUNS_DIR.mkdir(parents=True, exist_ok=True)

JAR = BENCHMARKING_DIR / "clinical-reasoning" / "build" / "libs" / "clinical-reasoning-benchmark-1.0.0-all.jar"
