...
WITH _patients AS
  ...
  (SELECT *
   ...
   WHERE EXTRACT(YEAR
                 FROM TRY_CAST(CAST(LEFT(REPLACE(CAST(intervalStart(fhirpath_text(InpatientEncounter.resource, 'period')) AS VARCHAR), ' ', 'T'), 10) AS VARCHAR) AS TIMESTAMP)) - EXTRACT(YEAR
                                                                                                                                                                                           FROM TRY_CAST(
                                                                                                                                                                                                           (SELECT _pd.birth_date
                                                                                                                                                                                                            ...
                                                                                                                                                                                                            LIMIT 1) AS TIMESTAMP)) - CASE
                                                                                                                                                                                                                                          WHEN EXTRACT(MONTH
                                                                                                                                                                                                                                                       FROM TRY_CAST(CAST(LEFT(REPLACE(CAST(intervalStart(fhirpath_text(InpatientEncounter.resource, 'period')) AS VARCHAR), ' ', 'T'), 10) AS VARCHAR) AS TIMESTAMP)) < EXTRACT(MONTH
                                                                                                                                                                                                                                                                                                                                                                                                                                 FROM TRY_CAST(
                                                                                                                                                                                                                                                                                                                                                                                                                                                 (SELECT _pd.birth_date
                                                                                                                                                                                                                                                                                                                                                                                                                                                  FROM _patient_demographics AS _pd
                                                                                                                                                                                                                                                                                                                                                                                                                                                  WHERE _pd.patient_id = InpatientEncounter.patient_id
                                                                                                                                                                                                                                                          ...
                                                                                                                                                                                                                                                          FROM TRY_CAST(CAST(LEFT(REPLACE(CAST(intervalStart(fhirpath_text(InpatientEncounter.resource, 'period')) AS VARCHAR), ' ', 'T'), 10) AS VARCHAR) AS TIMESTAMP)) = EXTRACT(MONTH
                                                                                                                                                                                                                                                                                                                                                                                                                                    FROM TRY_CAST(
                                                                                                                                                                                                                                                                                                                                                                                                                                                    (SELECT _pd.birth_date
                                                                                                                                                                                                                                                                                                                                                                                                                                                     ...
                                                                                                                                                                                                                                                                                                                                                                                                                                                     LIMIT 1) AS TIMESTAMP))
                                                                                                                                                                                                                                               AND EXTRACT(DAY
                                                                                                                                                                                                                                                           FROM TRY_CAST(CAST(LEFT(REPLACE(CAST(intervalStart(fhirpath_text(InpatientEncounter.resource, 'period')) AS VARCHAR), ' ', 'T'), 10) AS VARCHAR) AS TIMESTAMP)) < EXTRACT(DAY
                                                                                                                                                                                                                                                                                                                                                                                                                                     FROM TRY_CAST(
                                                                                                                                                                                                                                                                                                                                                                                                                                                     (SELECT _pd.birth_date
                                                                                                                                                                                                                                                                                                                                                                                                                                                      FROM _patient_demographics AS _pd
                                                                                                                                                                                                                                                                                                                                                                                                                                                      WHERE _pd.patient_id = InpatientEncounter.patient_id
