...
2.  **Translator Wheel**: `fhir4ds_v2-0.0.5-py3-none-any.whl` (the CQL-to-SQL translation module for Pyodide).
...
import micropip
await micropip.install("path/to/fhir4ds_v2-0.0.5-py3-none-any.whl")
