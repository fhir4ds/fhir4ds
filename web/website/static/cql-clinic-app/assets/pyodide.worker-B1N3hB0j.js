const u="https://cdn.jsdelivr.net/pyodide/v0.27.7/full/";let l=null;self.onmessage=async a=>{const{id:o,type:e,cql:s,audit:r}=a.data;if(e==="init"){try{await y(),self.postMessage({id:0,ok:!0})}catch(t){self.postMessage({id:0,ok:!1,error:t instanceof Error?t.message:String(t)})}return}if(e==="translate"){const t=performance.now();try{if(!l)throw new Error("Pyodide not initialized");const i=await m(s??"",r??!1),c=g(i),d=performance.now()-t;self.postMessage({id:o,ok:!0,sql:c,timeMs:d})}catch(i){self.postMessage({id:o,ok:!1,error:i instanceof Error?i.message:String(i)})}}};async function y(){const{loadPyodide:a}=await import(`${u}pyodide.mjs`);l=await a({indexURL:u}),await l.loadPackage(["micropip","duckdb","orjson","pyarrow"]);const o=new URL("./fhir4ds_v2-0.0.14-py3-none-any.whl",import.meta.url).href;console.log("[Pyodide Worker] Installing fhir4ds-v2 from:",o),l.globals.set("__wheel_url__",o),await l.runPythonAsync(`
import micropip
