"""
FHIRPath Math functions as DuckDB SQL macros.
...
def register_math_macros(con: "duckdb.DuckDBPyConnection") -> None:
    """
    Register math function macros (Tier 1).

    Registers native DuckDB SQL macros for FHIRPath math functions:
    - Abs, Ceiling, Floor, Round, Sqrt, Exp, Ln, Log, Power, Truncate
    ...
    # Round - two versions:
    # Round(x) defaults to 0 decimal places (FHIRPath default)
