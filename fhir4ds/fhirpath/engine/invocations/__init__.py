...
invocation_registry = {
    ...
    "convertsToBoolean": {"fn": misc.create_converts_to_fn(misc.to_boolean, 'bool'), "arity": {0: [], 1: [["Any"]]}},
    "convertsToInteger": {"fn": misc.create_converts_to_fn(misc.to_integer, 'int'), "arity": {0: [], 1: [["Any"]]}},
    "convertsToDecimal": {"fn": misc.create_converts_to_fn(misc.to_decimal, Decimal), "arity": {0: [], 1: [["Any"]]}},
    "convertsToString": {"fn": misc.create_converts_to_fn(misc.to_string, 'str'), "arity": {0: [], 1: [["Any"]]}},
    "convertsToDate": {"fn": misc.create_converts_to_fn(misc.to_date, FP_Date), "arity": {0: [], 1: [["Any"]]}},
    "convertsToDateTime": {"fn": misc.create_converts_to_fn(misc.to_date_time, FP_DateTime), "arity": {0: [], 1: [["Any"]]}},
    "convertsToTime": {"fn": misc.create_converts_to_fn(misc.to_time, FP_Time), "arity": {0: [], 1: [["Any"]]}},
    "convertsToQuantity": {"fn": misc.create_converts_to_fn(misc.to_quantity, FP_Quantity), "arity": {0: [], 1: [["Any"]]}},
