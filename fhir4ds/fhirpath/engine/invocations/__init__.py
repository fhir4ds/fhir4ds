...
invocation_registry = {
    ...
    "toDate": {"fn": misc.to_date, "arity": {0: []}},
    "toDateTime": {"fn": misc.to_date_time, "arity": {0: []}},
    ...
    "convertsToDate": {"fn": misc.create_converts_to_fn(misc.to_date, FP_Date), "arity": {0: []}},
    "convertsToDateTime": {"fn": misc.create_converts_to_fn(misc.to_date_time, FP_DateTime), "arity": {0: []}},
