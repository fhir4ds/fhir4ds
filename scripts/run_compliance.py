            ...
            "results": [
                {
                    ...
                    "expression": r.test_case.expression,
                    "passed": r.passed,
                    "actual_output": str(r.actual_output) if r.actual_output is not None else None,
...
def main():
    ...
    test_dir = args.test_dir or (project_root / "tests" / "compliance" / "r4")
